...
<!-- Grid System  -->
<div class="container">
    <h1 style="text-align:center;">National Voting</h1>
    <div class="row">
    <?php
    include('db.php');
    $fire="select * from nationalcard";
  ...
  <div class="card-body">
    <p class="card-text"><?php print $result['message'];?></p>
    <form action="processing.php?user_id=<?php echo $userdata['user_id']; ?>" method="POST" enctype="multipart/form-data">
    <?php
...
<hr>
    ...
    <div class="row">
      <div class="col-12">
    <a href="provience.php?user_id=<?php echo $userdata['user_id']; ?>"> <button class="btn btn-primary" style="width:100%;" >Cast a Province Vote</button></a>
