...
<!-- Grid System  -->
<div class="container">
    <h1 style="text-align:center;">National Voting Result</h1>
    <div class="row">
    <?php
    $user="localhost";
    $name="root";
...
<hr>
    ...
    <div class="row">
      <div class="col-12">
    <a href="presult.php?user_id=<?php echo $userdata['user_id']; ?>"> <button class="btn btn-primary" style="width:100%;" >For Province Result >></button></a>
